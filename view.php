...
<head>
    ...
    <style>body{background:#0E0E0E;color:#FFF;font-family:sans-serif;display:flex;align-items:center;justify-content:center;height:100vh;margin:0;text-align:center; padding:20px;}</style>
</head>
<body>
    <div><h1><?php echo $title; ?></h1><p><?php echo $message; ?></p><a href="/" style="color:#5DFFBF;">Volver al inicio</a></div>
</body>
</html>
<?php
    exit;
